...
Usage:
  ...
  python init_viasuperdev.py --complete
      Marks environment as initialized. Creates .claude/viasuperdev/ state dir.
  ...
  python init_viasuperdev.py --init-ag AG-XXXXX
      Creates .claude/viasuperdev/AG-XXXXX/branch-state.json with all fields
...
STATE_DIR_REL = ".claude/viasuperdev"   # relative to workspace root
