...
tarefa: analise tecnica com RAG semantico, implementacao Delphi em worktree isolado e abertura de PR.
...
- Cria pasta de estado `.claude/viasuperdev/`
...
**O que acontece:**
1. Lê a AG do vault e extrai criterios, RNs, processos e referencias tecnicas
2. Executa busca semantica em 4 camadas: ChromaDB KB → ChromaDB source → vault_search.py → Glob/Grep/Read
3. Monta `AG-XXXXX-context.md` com chunks priorizados e plano tecnico
4. Se houver ambiguidades, aciona brainstorm
5. Exibe link do context.md para sua revisao
...
5. Exibe mensagem de commit sugerida e link do PR

**O que voce faz:**
- Revisar o codigo gerado antes de confirmar o salvamento
- Testar no Delphi / RAD Studio
- Fazer commit e push manualmente
- Abrir o PR (link fornecido pela skill)
- Confirmar quando o PR foi aberto
